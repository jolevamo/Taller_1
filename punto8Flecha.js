...
planetas.forEach(agua=>{sumaAgua = sumaAgua + agua.VolumenTotalAguaM3})

//Se imprime la suma de agua
...
planetas.forEach(oxigeno=>{sumaOxigeno = sumaOxigeno + oxigeno.nivelOxigeno})
...
let oxigenoNegativo = planetas.filter(OxiNeg=>{return(OxiNeg.nivelOxigeno<0)})
...
//Función para identificar los planetas que no tienen agua
let planetaSinAgua = planetas.filter(plaSinAg=>{return(plaSinAg.VolumenTotalAguaM3==0)})
